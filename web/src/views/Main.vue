<template>
    <div>
        <div class="topbar bg-black py-2 px-3 d-flex ai-center">
            <img src="//game.gtimg.cn/images/yxzj/cp/a20190320bbgxsmm/logo.png" height="30" alt="">
            ...
            <button type="button" href="" class="btn bg-primary">立即下载</button>
        </div>

        <div class="bg-primary pt-3 pb-2">
            <div class='nav nav-inverse jc-around pb-1 text-white'>
